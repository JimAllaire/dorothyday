...
turn the corner from the subway. Poverty, destitution, vice, are all
...
This has been done, in connection with other Houses, but it ends in
...
If we do not want to render to [[2]]($-0) Caesar, we must be careful not
